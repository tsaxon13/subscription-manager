...
class MigrationEngine(object):
    ...
    def clean_up(self, subscribed_channels):
        ...
        if os.path.isfile(os.path.join(product_dir.path, "68.pem")) and \
            ...
            try:
                ...
                self.db.delete("68")
                self.db.write()
                log.debug("Removed 68.pem due to existence of 71.pem")
            except OSError as e:
                log.error(e)
    ...
    def disable_yum_rhn_plugin(self):
        ...
        """
        log.debug("Disabling rhnplugin.conf")
    ...
    def legacy_purge(self, rpc_session, session_key):
        ...
        log.debug("Deleting system %s from legacy server...", self.system_id)
        try:
